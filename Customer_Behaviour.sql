...
SELECT 
	shipping_type, 
	ROUND(AVG(purchase_amount),2) AS Average_Purchase_Amounts
FROM customer
WHERE shipping_type IN ('Standard','Express')
GROUP BY shipping_type;

-- Q.5 Do subscibed customers spend more? Compare average spend and total revenue between subscibers and non-subscribers.
SELECT 
	subscription_status,
...
-- Q.6 Which 5 products have the highest percentage of purchased with discounts applied?
SELECT 
	item_purchased,
